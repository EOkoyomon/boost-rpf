...
class BiasCorrector:
    ...
    # def fit(self, X_train, target_train, pred_train, X_val, target_val, pred_val, verbose=False):
...
class NativeXGBModelWrapper:
    ...
    def predict_linear(self, num_nodes, paths, use_corrector_if_available=True):
        ...
        if self.corrector is not None and use_corrector_if_available:

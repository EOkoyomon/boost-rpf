...
df_exp1 = pd.read_csv("experiment_1_results_with_seed.csv")
df_exp2 = pd.read_csv("experiment_2_results_with_seed.csv")
df_exp3 = pd.read_csv("experiment_3_results_with_seed.csv")
...
def plot_inference_time_scaling(df_all, grid_to_num_noodes, save=False):
    ...
    if save:
        plt.savefig("inference_time_scaling.pdf", format="pdf", dpi=300)
    plt.show()
...
def plot_vm_boxplot(df_all, metric, save=False):
    ...
    if save:
        plt.savefig(f"voltage_{metric}_boxplot.pdf", format="pdf", dpi=300)
    plt.show()

plot_inference_time_scaling(df_all, grid_to_num_noodes, save=False)
plot_vm_boxplot(df_all, metric='rmse_vm_pu', save=False)
plot_vm_boxplot(df_all, metric='rmse_va_degree', save=False)